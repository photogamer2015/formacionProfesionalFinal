...
urlpatterns = [
    ...
    path('matricula/<str:modalidad>/retirados/',
         views.matricula_lista, {'solo_retirados': True},
         name='matricula_retirados'),
    ...
    path('matricula/<int:pk>/retiro/revertir/',
         views_pagos.matricula_revertir_retiro,
         name='matricula_revertir_retiro'),
    ...
    path('admin-panel/actividad-usuarios/',
         views_admin.actividad_usuarios, name='actividad_usuarios'),
    path('admin-panel/actividad-usuarios/pdf/',
         views_admin.actividad_usuarios_pdf, name='actividad_usuarios_pdf'),
