"""Regresión de persistencia y cierre explícito para cualquier rol."""
        ...
        for rol in ('Administradores', 'Asesores', 'Usuario', 'Superusuario'):
            with self.subTest(rol=rol):
                user = User.objects.create_user(
                    username=rol, is_superuser=rol == 'Superusuario',
                ...
                # Reabrir el navegador conservando únicamente su cookie persistente.
                reabierto = Client()
                ...
                # Ni la cookie antigua permite recuperar una sesión cerrada.
